...
def get_brand(id):
    ...
    brand = Addproduct.query.filter_by(brand=get_brand).paginate(page=page, per_page=30)
...
def addproduct():
    ...
    if request.method=="POST"and 'image_1' in request.files:
        ...
        addproduct = Addproduct(name=name,price=price,discount=discount,stock=stock,desc=desc,category_id=category,brand_id=brand,image_1=image_1,image_2=image_2,image_3=image_3)
